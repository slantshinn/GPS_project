...
while (rs.next()) {
		out.println("<tr>");
		out.println("<td><a href='Project_Update_UI.jsp?_pname="+rs.getString("pname")+"&_pscale="+rs.getString("pscale")+"&_pnom="+rs.getString("pnom")+"&_dueDate="+rs.getString("pduedate")+"&_descr="+rs.getString("pdescr")+"&_pnoo="+rs.getString("object")+"'>"+rs.getString("pname") + "</a></td>");
